      ...
      const mockTasks: Task[] = [
        {
          ...
          description: "Go through the latest client proposals and provide feedback",
          status: "todo",
          priority: "high",
          estimatedHours: "4",
          dueDate: "2024-01-15",
          ...
          checklist: [
            { id: "1", text: "Review proposal A", completed: false },
            { id: "2", text: "Review proposal B", completed: true }
          ],
          createdBy: 1,
        ...
        },
        {
          ...
          description: "Complete the documentation for the new design system",
          status: "review",
          priority: "low",
          estimatedHours: "6",
          dueDate: "2024-01-20",
          ...
          checklist: [
            { id: "1", text: "Component library docs", completed: true },
            { id: "2", text: "Usage guidelines", completed: true },
            { id: "3", text: "Examples section", completed: false }
          ],
          createdBy: 1,
        ...
        },
        {
          ...
          description: "Prepare materials and agenda for upcoming client meeting",
          status: "done",
          priority: "medium",
          estimatedHours: "1",
          completedAt: "2024-01-09T17:00:00Z",
          position: 0,
          labels: ["meeting", "client-work"],
          checklist: [
            { id: "1", text: "Create agenda", completed: true },
        ...
        },
        {
          ...
          description: "Review pull requests for the latest feature implementations",
          status: "todo",
          priority: "urgent",
          estimatedHours: "3",
          dueDate: "2024-01-11",
        ...
        },
        {
          ...
          description: "Compile and distribute standup meeting notes",
          status: "in_progress",
          priority: "low",
          estimatedHours: "0.5",
          position: 1,
          labels: ["meeting", "team"],
          checklist: [
            { id: "1", text: "Collect updates from team", completed: true },
            { id: "2", text: "Format notes", completed: false },
            { id: "3", text: "Send to stakeholders", completed: false }
          ],
          createdBy: 1,
